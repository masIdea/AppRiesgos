...
class Direcciones(models.Model):
    ...
    class Meta:
        ...
        unique_together = (('iddireccion', 'gerencia'),)
...
class Riesgo(models.Model):
    ...
    directic = models.NullBooleanField()
...
class RiesgoControl(models.Model):
    ...
    nombrecontrol = models.CharField(db_column='NombreControl', max_length=255, blank=True, null=True)  # Field name made lowercase.  
    descripcioncontrol = models.TextField(db_column='DescripcionControl', blank=True, null=True)  # Field name made lowercase. This field type is a guess.
...
class RiesgoControlEvidencia(models.Model):
    ...
    archivo = models.CharField(db_column='Archivo', max_length=255, primary_key=True)  # Field name made lowercase.
    estadoregistro = models.CharField(db_column='EstadoRegistro', max_length=255, blank=True, null=True)  # Field name made lowercase.
    modificado = models.DateTimeField(db_column='Modificado', blank=True, null=True)  # Field name made lowercase.
    creado = models.DateTimeField(db_column='Creado', blank=True, null=True)  # Field name made lowercase.
    creadopor = models.CharField(db_column='Creadopor', max_length=255, blank=True, null=True)  # Field name made lowercase.
...
class RiesgoEvaluacioncualitativaobjetivo(models.Model):
    ...
    probabilidadcontrol = models.CharField(db_column='ProbabilidadControl', max_length=255, blank=True, null=True)  # Field name made lowercase.
...
class RiesgoPlanderespuestaActividad(models.Model):
    ...
    idactividad = models.CharField(db_column='IdActividad', max_length=255, primary_key=True)  # Field name made lowercase.
...
class RiesgoCargasistemacio(models.Model):
    idcargacio = models.CharField(db_column='IdCargaCIO', max_length=255, blank=True, null=True)  # Field name made lowercase.
    ...
    cantidaddiasdetencion = models.FloatField(db_column='CantidadDiasDetencion', blank=True, null=True)  # Field name made lowercase.
    cantidadtmfperdidas = models.FloatField(db_column='CantidadTMFPerdidas', blank=True, null=True)  # Field name made lowercase.
    montodeperdida = models.FloatField(db_column='MontoDePerdida', blank=True, null=True)  # Field name made lowercase.
...
class RiesgoCargasisteman1(models.Model):
    idcargan1 = models.CharField(db_column='IdCargaN1', max_length=255, blank=True, null=True)  # Field name made lowercase.
    ...
    idn1 = models.CharField(db_column='idN1', max_length=50, primary_key=True)  # Field name made lowercase.
...
class RiesgoUnifica(models.Model):
    ...
    qhorasdetencion = models.FloatField(db_column='QHorasDetencion', blank=True, null=True)  # Field name made lowercase.
    qdiasdetencion = models.FloatField(db_column='QDiasDetencion', blank=True, null=True)  # Field name made lowercase.
    qktsperdida = models.FloatField(db_column='QKtsPerdida', blank=True, null=True)  # Field name made lowercase.
    qtmfperdida = models.FloatField(db_column='QTMFperdida', blank=True, null=True)  # Field name made lowercase.
    qlibrasperdida = models.FloatField(db_column='QLibrasPerdida', blank=True, null=True)  # Field name made lowercase.
    montoperdidakusd = models.FloatField(db_column='MontoPerdidaKUSD', blank=True, null=True)  # Field name made lowercase.
